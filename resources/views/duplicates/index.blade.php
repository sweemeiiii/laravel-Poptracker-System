...
@section('content')
    ...
    <!-- 📦 Grouped Series -->
    @forelse($groupedDuplicates as $seriesName => $items)
                ...
                @foreach ($items as $item)
                    <div class="col-md-4 mb-4 figurine-card" 
                        ...
                        <div class="card position-relative">
                            <!-- Remove Button -->
                            <form action="{{ route('duplicates.destroy', $item->figurine_id) }}" method="POST"
                                  onsubmit="return confirm('Are you sure you want to remove this figurine from your Duplicates?');"
    ...
    @empty
        <p>No duplicate figurines found.</p>
    @endforelse
