...
@section('content')
    ...
    @forelse($groupedWishlist as $seriesName => $items)
                ...
                @foreach ($items as $item)
                    ...
                    data-series="{{ strtolower($item->figurine->series) }}" >
                        <div class="card position-relative">
                            <form action="{{ route('wishlists.destroy', $item->figurine_id) }}" method="POST" 
                                  onsubmit="return confirm('Are you sure you want to remove this figurine from your Wish List?');"
